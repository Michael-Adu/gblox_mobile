            ...
            onNotePositionTapped: (position) {
              ...
              try {
                global.activeConnection.output.add(
                    Uint8List.fromList(utf8.encode("piano " + commandArgs)));
